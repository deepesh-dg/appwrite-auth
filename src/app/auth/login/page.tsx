...
export default function Login() {
    ...
    //         .setJWT(
    //             "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOiI2NDliYzY5NDdiYjJiNDVmYzQ1NiIsInNlc3Npb25JZCI6IjY0OWJjNzU2MzkwNGFkN2JhOTVjIiwiZXhwIjoxNjg3OTMxNjEwfQ.GsOc2tLmFfSecSj4L4NWyPcIeXYytRU_QQhNGvweh6k"
    //         );
    //     const account = new Account(client);
    //     account.get().then((data) => console.log({ userData: data }));
    // })();
    ...
    const login = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const userData = await account.createEmailSession(data.email, data.password);
